"""create charityproject and donaton tables

Revision ID: 9f585e7b7471
Revises: 
Create Date: 2025-06-12 23:18:31.135671
...
def upgrade():
    ...
    sa.Column('create_date', sa.DateTime(), nullable=True),
    sa.Column('close_date', sa.DateTime(), nullable=True),
    sa.Column('fk_donation_user_id_user', sa.Integer(), nullable=False),
